...
frame = tk.Frame(master=window, bg="skyblue", padx=20)
frame.pack()
...
button_perc = tk.Button(master=frame, text='%', padx=15,
                        pady=5, width=3, command=lambda: myclick('%'))
button_perc.grid(row=1, column=0, pady=2)
button_clear = tk.Button(master=frame, text="clear",
                         padx=15, pady=5, width=3, command=clear)
button_clear.grid(row=1, column=1, columnspan=1, pady=2)
button_back = tk.Button(master=frame, text='B', padx=15,
                        pady=5, width=3, command=backspace)
button_back.grid(row=1, column=2, pady=2)
...
button_multiply.grid(row=6, column=1, pady=2)
...
button_subtract = tk.Button(
    master=frame, text="-", padx=15, pady=5, width=3, command=lambda: myclick('-'))
button_subtract.grid(row=5, column=2, pady=2)
